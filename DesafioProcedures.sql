...
BEGIN
		case escolha 
            ...
            when 3 then  CALL setNota('Roberto Alves', '12245678914', '31325678123421', 'Eletrõnico', 'FECHADO', 495.68, 25.49);
            when 4 then  CALL updateNota(485.68);
            when 5 then  CALL deleteNota('Roberto Alves');
            when 6 then  CALL dropNota();
		end case;
END//
DELIMITER ;
